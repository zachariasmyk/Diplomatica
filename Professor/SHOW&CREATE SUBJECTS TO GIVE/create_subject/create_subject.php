...
<h1 class="welcome-text">Φόρμα Δημιουργίας Θέματος Διπλωματικής</h1>
  ...
  <div class="diploma-form-wrapper">
    <form id="diplomaFormUnique">
      <h2 class="diploma-form-title">Καταχώρηση Διπλωματικής</h2>

      <label for="diplomaTitle">Θέμα:</label>
      <input type="text" id="diplomaTitle" name="diplomaTitle" required>

      <label for="diplomaOutline">Περίγραμμα:</label>
      <textarea id="diplomaOutline" name="diplomaOutline" required></textarea>

      <label for="diplomaFiles">Επισύναψη Αρχείων:</label>
      <input type="file" id="diplomaFiles" name="diplomaFiles" multiple>

      <button type="submit">Υποβολή</button>

      <div class="diploma-success-message" id="diplomaSuccessMsg"></div>
    </form>
  </div>
  
  <script src="create_subject.js"></script>
</body>
</html>
