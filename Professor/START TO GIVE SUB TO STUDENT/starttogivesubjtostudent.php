...
<head>
    ...
    <link rel="stylesheet" href="starttogivesubjtostudent.css">
</head>
...
<body>
 ...
 <h1 class=>Αρχική ανάθεση θέματος σε φοιτητή </h1>

    <!-- Φόρμα αναζήτησης -->
    <form method="POST">
        <label for="search_am">Αριθμός Μητρώου Φοιτητή:</label>
        <input type="text" name="search_am" required>
   ...
   <div id="sidebar1" class="sidebar1">
    ...
    <ul>
      ...
      <li><a href="../DIPLOMATIC LIST/diplomaticlist.php">Προβολή λίστας διπλωματικών</a></li>
  ...
  <script src="starttogivesubjtostudent.js"></script>
