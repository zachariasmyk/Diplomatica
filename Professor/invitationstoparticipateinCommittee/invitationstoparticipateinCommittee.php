...
<head>
    ...
    <link rel="stylesheet" href="invitationstoparticipateinCommittee.css">
</head>
...
<h1 class="welcome-text">Αιτήματα για Συμμετοχή σε Τριμελής Επιτροπή</h1>
  ...
  <script src="invitationstoparticipateinCommittee.js"></script>
