...
<head>
    ...
    <link rel="stylesheet" href="Diplomaticworkmanagement.css">
</head>
...
<h1 class="welcome-text">Διαχείρηση Διπλωματικών Εργασιών</h1>
  ...
  <script src="Diplomaticworkmanagement.js"></script>
